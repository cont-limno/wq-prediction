...
plotE_TP <- ggplot(datatab, aes(x=tp, fill=factor(cluster_random50_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
  scale_x_continuous(limits=TP_xlims)+
  scale_y_continuous(limits=TP_ylims)+
  #annotation_custom(variable_label)+
...
# random25_holdout
plotA_chla <- ggplot(datatab, aes(x=chal, fill=factor(random25_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
...
# random75_holdout
plotB_chla <- ggplot(datatab, aes(x=chal, fill=factor(random75_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
  scale_x_continuous(limits=chla_xlims)+
  scale_y_continuous(limits=chla_ylims)+
  #annotation_custom(variable_label)+
...
# cluster_strat75_holdout
plotC_chla <- ggplot(datatab, aes(x=chal, fill=factor(cluster_strat75_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
  scale_x_continuous(limits=chla_xlims)+
  scale_y_continuous(limits=chla_ylims)+
  #annotation_custom(variable_label)+
...
# hu4_strat75_holdout
plotD_chla <- ggplot(datatab, aes(x=chal, fill=factor(hu4_strat75_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
  scale_x_continuous(limits=chla_xlims)+
  scale_y_continuous(limits=chla_ylims)+
  #annotation_custom(variable_label)+
...
# cluster_random50_holdout
plotE_chla <- ggplot(datatab, aes(x=chal, fill=factor(cluster_random50_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
  scale_x_continuous(limits=chla_xlims)+
  scale_y_continuous(limits=chla_ylims)+
  #annotation_custom(variable_label)+
...
# hu4_random50_holdout
plotF_chla <- ggplot(datatab, aes(x=chal, fill=factor(hu4_random50_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
  scale_x_continuous(limits=chla_xlims)+
  scale_y_continuous(limits=chla_ylims)+
  #annotation_custom(variable_label)+
...
# hu4_ag50_holdout
plotG_chla <- ggplot(datatab, aes(x=chal, fill=factor(hu4_ag50_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
  scale_x_continuous(limits=chla_xlims)+
  scale_y_continuous(limits=chla_ylims)+
  #annotation_custom(variable_label)+
...
# random25_holdout
plotA_TN <- ggplot(datatab, aes(x=tn, fill=factor(random25_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
...
# random75_holdout
plotB_TN <- ggplot(datatab, aes(x=tn, fill=factor(random75_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
  scale_x_continuous(limits=TN_xlims)+
  scale_y_continuous(limits=TN_ylims)+
  #annotation_custom(variable_label)+
...
# cluster_strat75_holdout
plotC_TN <- ggplot(datatab, aes(x=tn, fill=factor(cluster_strat75_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
  scale_x_continuous(limits=TN_xlims)+
  scale_y_continuous(limits=TN_ylims)+
  #annotation_custom(variable_label)+
...
# hu4_strat75_holdout
plotD_TN <- ggplot(datatab, aes(x=tn, fill=factor(hu4_strat75_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
  scale_x_continuous(limits=TN_xlims)+
  scale_y_continuous(limits=TN_ylims)+
  #annotation_custom(variable_label)+
...
# cluster_random50_holdout
plotE_TN <- ggplot(datatab, aes(x=tn, fill=factor(cluster_random50_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
  scale_x_continuous(limits=TN_xlims)+
  scale_y_continuous(limits=TN_ylims)+
  #annotation_custom(variable_label)+
...
# hu4_random50_holdout
plotF_TN <- ggplot(datatab, aes(x=tn, fill=factor(hu4_random50_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
  scale_x_continuous(limits=TN_xlims)+
  scale_y_continuous(limits=TN_ylims)+
  #annotation_custom(variable_label)+
...
# hu4_ag50_holdout
plotG_TN <- ggplot(datatab, aes(x=tn, fill=factor(hu4_ag50_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
  scale_x_continuous(limits=TN_xlims)+
  scale_y_continuous(limits=TN_ylims)+
  #annotation_custom(variable_label)+
...
# cluster_random50_holdout
plotE_Secchi <- ggplot(datatab, aes(x=secchi, fill=factor(cluster_random50_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
  scale_x_continuous(limits=secchi_xlims)+
  scale_y_continuous(limits=secchi_ylims)+
  #annotation_custom(variable_label)+
...
# cluster_random50_holdout
plotE_depth <- ggplot(datatab, aes(x=maxdepth_m, fill=factor(cluster_random50_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
  scale_x_continuous(limits=depth_xlims)+
  scale_y_continuous(limits=depth_ylims)+
  #annotation_custom(variable_label)+
...
# cluster_random50_holdout
plotE_forest <- ggplot(datatab, aes(x=iws_nlcd2006_for, fill=factor(cluster_random50_holdout))) + geom_density(alpha=0.75)+
  theme_bw()+
  scale_x_continuous(limits=forest_xlims)+
  scale_y_continuous(limits=forest_ylims)+
  #annotation_custom(variable_label)+
...
jpeg('graphics/density_plots/all_vars_scenarios.jpeg',width = 6.5,height = 6.5,units = 'in',res=600)
